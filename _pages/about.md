...
- Optimized essential components of home-based wearable biosensor for monitoring vitals of 
  suspected Covid-19 patients with focus on blood oxygen
- Designed part of RTL model to control light-emitting diodes (LEDs), light sensors, and 
  interpret data
- Successfully achieved design goal of 40 KHz refresh rate for LEDs in device
- Developed and implemented test protocols to validate proposed design concepts for LED Control 
